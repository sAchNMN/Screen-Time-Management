...
jpackage --type app-image --name "%APP_NAME%" --app-version %APP_VERSION% --vendor "ScreenTime" --description "屏幕时间管理" --input target\staging --main-jar screen-time-management-1.0-SNAPSHOT.jar --main-class com.screentime.App --java-options "-Dprism.order=sw" --icon target/icon.ico --dest dist
